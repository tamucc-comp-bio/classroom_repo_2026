...
Accept **Lecture 2** using the [Classroom 50, Lecture 2 link](https://classroom50.org/tamucc-comp-bio-assignments/comp-bio-skills-2026/assignments/lecture-2v2/accept). Classroom 50 creates your personal GitHub repository, just as it did for Lecture 1 and Assignment 1.  Clone the `lecture-2` repository to your local computer. 
...
<details><summary>Administrator commands (`sudo`)</summary>
